...
export class Migration1716812996906 implements MigrationInterface {
    name = 'Migration1716812996906'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Transaction" ("id" integer NOT NULL, "name" character varying NOT NULL, "status" integer NOT NULL, "senderId" integer, "receiverId" integer, "tripId" integer, "invoiceId" integer, CONSTRAINT "REL_9928ad54f448b90a719334fdc0" UNIQUE ("tripId"), CONSTRAINT "REL_93b0e22bf2727fc5969cc81b38" UNIQUE ("invoiceId"), CONSTRAINT "PK_21eda4daffd2c60f76b81a270e9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "Tracker" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "date" TIMESTAMP NOT NULL, "timing" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "senderUserId" integer, "receiverUserId" integer, "tripId" integer, CONSTRAINT "REL_37d36117f596ca4114398cef06" UNIQUE ("tripId"), CONSTRAINT "PK_a89e172146a6a8de0caab70c7cc" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "Reviews" ("id" SERIAL NOT NULL, "value" character varying NOT NULL, "rating" integer NOT NULL, "userId" integer, "reviewedUserId" integer, CONSTRAINT "REL_d35e4f965fb0315258de04f006" UNIQUE ("reviewedUserId"), CONSTRAINT "PK_5ae106da7bc18dc3731e48a8a94" PRIMARY KEY ("id"))`);
